...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Note<T extends NoteFindManyArgs= {}>(args?: Subset<T, NoteFindManyArgs>): PrismaPromise<Array<NoteGetPayload<T>>| Null>;
  ...
  export type NoteGetPayload<S extends boolean | null | undefined | NoteArgs> =
    ...
    : S extends { select: any } & (NoteArgs | NoteFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'owner' ? UserGetPayload<S['select'][P]> :  P extends keyof Note ? Note[P] : never
  } 
      : Note
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__NoteClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type UserWhereInput = {
    ...
    ntfyTopic?: StringNullableFilter | string | null
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    ntfyTopic?: StringNullableWithAggregatesFilter | string | null
  ...
  export type NoteWhereInput = {
    ...
    allDay?: BoolNullableFilter | boolean | null
    createdAt?: DateTimeFilter | Date | string
    updatedAt?: DateTimeFilter | Date | string
  ...
  export type NoteScalarWhereWithAggregatesInput = {
    ...
    allDay?: BoolNullableWithAggregatesFilter | boolean | null
    createdAt?: DateTimeWithAggregatesFilter | Date | string
    updatedAt?: DateTimeWithAggregatesFilter | Date | string
  }
  ...
  export type UserUpdateInput = {
    ...
    ntfyTopic?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type NoteCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    owner: UserCreateNestedOneWithoutNoteInput
  }
  ...
  export type NoteUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    owner?: UserUpdateOneRequiredWithoutNoteNestedInput
  }
  ...
  export type NoteCreateNestedManyWithoutOwnerInput = {
    create?: XOR<Enumerable<NoteCreateWithoutOwnerInput>, Enumerable<NoteUncheckedCreateWithoutOwnerInput>>
    connectOrCreate?: Enumerable<NoteCreateOrConnectWithoutOwnerInput>
  ...
  export type NoteUpdateManyWithoutOwnerNestedInput = {
    create?: XOR<Enumerable<NoteCreateWithoutOwnerInput>, Enumerable<NoteUncheckedCreateWithoutOwnerInput>>
    connectOrCreate?: Enumerable<NoteCreateOrConnectWithoutOwnerInput>
    upsert?: Enumerable<NoteUpsertWithWhereUniqueWithoutOwnerInput>
    createMany?: NoteCreateManyOwnerInputEnvelope
    set?: Enumerable<NoteWhereUniqueInput>
    disconnect?: Enumerable<NoteWhereUniqueInput>
    delete?: Enumerable<NoteWhereUniqueInput>
    connect?: Enumerable<NoteWhereUniqueInput>
    update?: Enumerable<NoteUpdateWithWhereUniqueWithoutOwnerInput>
    updateMany?: Enumerable<NoteUpdateManyWithWhereWithoutOwnerInput>
  ...
  export type NoteCreateManyOwnerInputEnvelope = {
    data: Enumerable<NoteCreateManyOwnerInput>
    skipDuplicates?: boolean
  }
